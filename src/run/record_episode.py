...
Sample usage:
python src/run/record_episode.py --model_path data/models/sac_checkpoint_cheetah_123456_10000 --env_name HalfCheetah-v4 --save_path data/videos/cheetah_123456_10000.mp4
"""
# imports
import os
import tree
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path',
                        type=str,
                        default='data/videos/cheetah_123456_10000.mp4',
