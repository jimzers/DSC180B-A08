"""
Record a single episode of the environment and save it to a video file.

Sample usage:
python src/run/record_episode_bc.py --model_path data/bc_model/cheetah_123456_10000_nonoise --env_name HalfCheetah-v4 --save_path data/videos/cheetah_123456_10000_bcmodel_nonoise.mp4
python src/run/record_episode_bc.py --model_path data/bc_model/cheetah_123456_10000_actnoise080 --env_name HalfCheetah-v4 --save_path data/videos/cheetah_123456_10000_bcmodel_actnoise080.mp4
"""
# imports
import os
import tree
...
from src.activations import init_hook_dict, recordtodict_hook, get_kinematics, save_hook_dict, create_stitched_img
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path',
                        type=str,
                        default='data/bc_model/cheetah_123456_10000_nonoise',
                        help='path to model')
    ...
    parser.add_argument('--save_path',
                        type=str,
                        default='data/videos/cheetah_123456_10000_bcmodel_nonoise.mp4',
    ...
    writer = imageio.get_writer(args.save_path, fps=50)
    ...
    while not time_step.last():  # or env.get_termination()
        ...
        # record video
        stitched_img = create_stitched_img(env, num_cams=1)  # choose to use just one camera for now
