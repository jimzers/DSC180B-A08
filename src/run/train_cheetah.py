...
from src.sac import SAC, ReplayMemory

"""
Sample usage:

python3 train_cheetah.py --automatic_entropy_tuning=True
"""
...
# Environment
cheetah_env = suite.load(domain_name="cheetah", task_name="run")
...
for i_episode in itertools.count(1):
    ...
    if i_episode % 10 == 0 and args.eval is True:
        ...
        agent.save_checkpoint(args.env_name, str(args.seed) + "_" + str(i_episode))
